...
<h3>ENTER YOUR NAME :NAUHSEEN FATHIMA A</h3>
...
Thus, Implementation of sum arrays on host and device is done in nvcc cuda using random number and threads = 256 has the minimum Time elapse.
